...
import { save, optionsParcel, optionsIsPaid} from '../services';
...
export function TransactionInsert() {
    ...
    const [idCreditCard, setIdCreditCard] = useState<AccountProps[]>([]);
    ...
    async function saveAccount() {
        const dados = await save({ description, value, name, installment, is_income: isIncome,due_date: dueDate, id_account: idAccount, id_creditcard: idCreditCard, is_paid: isPaid }).then(() => {
